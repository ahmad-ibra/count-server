...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/ahmad-ibra/count-server/gen/count/v1"
	http "net/http"
	strings "strings"
)
...
var (
	countServiceServiceDescriptor     = v1.File_count_v1_count_proto.Services().ByName("CountService")
	countServiceCountMethodDescriptor = countServiceServiceDescriptor.Methods().ByName("Count")
)
...
func NewCountServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CountServiceClient {
	...
	return &countServiceClient{
		count: connect.NewClient[v1.CountRequest, v1.CountResponse](
			...
			connect.WithSchema(countServiceCountMethodDescriptor),
